...
const (
	...
	LinkService_AddLink_FullMethodName = "/link_service.LinkService/AddLink"
)
...
func (c *linkServiceClient) AddLink(ctx context.Context, in *AddLinkRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedLinkServiceServer) AddLink(context.Context, *AddLinkRequest) (*emptypb.Empty, error) {
